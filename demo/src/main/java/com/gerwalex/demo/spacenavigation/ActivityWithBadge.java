    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spaceNavigationView.setSpaceOnLongClickListener(new SpaceOnLongClickListener() {
            ...
            public void onCentreButtonLongClick() {
                Toast
                        .makeText(ActivityWithBadge.this, "onCentreButtonLongClick", Toast.LENGTH_SHORT)
                        .show();
            }
            ...
            public void onItemLongClick(int itemIndex, String itemName) {
                Toast
                        .makeText(ActivityWithBadge.this, itemIndex + " " + itemName, Toast.LENGTH_SHORT)
                        .show();
            }
        });
            ...
            public void onClick(int position) {
                if (position == 0) {
                    spaceNavigationView.showBadgeAtIndex(1, 54,
                            ContextCompat.getColor(ActivityWithBadge.this, R.color.badge_background_color));
                } else if (position == 1) {
